...
describe Flapjack::Data::Contact, :redis => true do
  ...
  let(:general_notification_rule_data) {
    {:entities           => [],
     ...
     :time_restrictions  => [],
     :unknown_media      => [],
     :warning_media      => ['email', 'sms', 'slack', 'sms_twilio', 'sms_nexmo', 'jabber', 'pagerduty', 'sns', 'voiceblue_email2sms', 'hipchat'],
     :critical_media     => ['email', 'sms', 'slack', 'sms_twilio', 'sms_nexmo', 'jabber', 'pagerduty', 'sns', 'voiceblue_email2sms', 'hipchat'],
     :unknown_blackhole  => false,
     :warning_blackhole  => false,
     :critical_blackhole => false}
  }
