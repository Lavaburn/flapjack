(function(flapjack, Contact) {
  ...
  Contact.Views.MediaList = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      _.each(['email', 'sms', 'slack', 'sms_twilio', 'sms_nexmo', 'sns', 'jabber', 'voiceblue_email2sms', 'hipchat'], function(type) {
  ...
  Contact.Views.MediaListItem = Backbone.View.extend({
    ...
    render: function() {
      ...
      template_values['labels'] = {
        ...
        'sns'        		  : 'SMS (Amazon SNS)',
        'jabber'     		  : 'Jabber',
        'voiceblue_email2sms' : 'Voiceblue Email2SMS',
        'hipchat'             : 'Hipchat (Room notification)',
      };
      this.$el.html(this.template(template_values));
      return this;
    },
